...
<section class="hero" id="intro">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3 text-center"> <a href="#about" class="learn-more-btn btn-scroll">Learn more</a> </div>
    </div>
  </div>
</section>
...
<!-- Section: about -->
<section id="about" class="home-section color-dark bg-gray">
      ...
      <div class="row animatedParent">
        ...
        <div class="col-md-4">
          <div class="animated rotateInDownLeft slow">
            <div class="service-box">
              <div class="service-icon"> <span class="fa fa-pencil-square-o fa-2x"></span> </div>
              <div class="service-desc">
        ...
        <div class="col-md-4">
          <div class="animated rotateInDownLeft slower">
            <div class="service-box">
              <div class="service-icon"> <span class="fa fa-question-circle fa-2x"></span> </div>
              <div class="service-desc">
                <h5>need Help</h5>
                <div class="divider-header"></div>
                <p style="color:#FFF;"> Ad denique euripidis signiferumque vim, iusto admodum quo cu. No tritani neglegentur mediocritatem duo. </p>
